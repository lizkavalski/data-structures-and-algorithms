...
//  used filter and reduce because I needed to filter through each of the array and pull the repeated numbers out, and then then the total of time it repeaed 
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
//I need to filter the numbers that cannot be divied by 5 and then from the result to applied with the power of two with it.
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
